...
const (
	...
	// Auth error codes
	ERR_INVALID_USERNAME_ERR_CODE    = CODE_SCOUT_SERVICE_PREFIX_ERR_CODE + 30000
	...
	// Auth error messages
	ERR_INVALID_USERNAME_ERR    = "Username cannot be empty"
	ERR_INVALID_PASSWORD_ERR    = "Password must be at least 6 characters"
	ERR_USER_ALREADY_EXISTS_ERR = "User already exists"
	ERR_INVALID_CREDENTIALS_ERR = "Invalid username or password"
